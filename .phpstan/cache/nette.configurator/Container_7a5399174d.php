...
class Container_7a5399174d extends _PHPStan_d91411b2a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService044(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_7a5399174d $container)
			{
	...
	public function createServiceContainer(): Container_7a5399174d
	{
		return $this;
	}
