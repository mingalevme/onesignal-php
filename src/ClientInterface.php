...
interface ClientInterface
{
    ...
    public const COLLAPSE_ID = 'collapse_id'; // This is known as APNS-collapse-id on iOS 10+ and collapse_key on Android.
     ...
     * @return array{id: non-empty-string, recipients: positive-int}
     * @throws Exception
     */
